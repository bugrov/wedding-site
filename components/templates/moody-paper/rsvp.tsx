...
const inputClassName =
  "mt-1 min-h-11 w-full border-0 border-b border-(--color-text)/30 bg-transparent px-0 py-2 text-sm text-(--color-text) focus:border-(--color-text) focus:outline-none";
