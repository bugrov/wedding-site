...
import { PinkSketchCalendar } from "./wedding-calendar";

export function PinkSketchTimer({ project }: BlockProps<"timer">) {
  ...
  return (
    <Section bleed="contained" className="text-center">
      ...
      <div className="mt-8 flex justify-center gap-6 md:gap-14">
        {units.map(([label, value]) => (
          <div key={label}>
            <div
              className="text-5xl text-(--color-primary) md:text-7xl"
      ...
      <div className="mt-12">
        <PinkSketchCalendar date={project.weddingDate} />
      </div>
    </Section>
  );
}
