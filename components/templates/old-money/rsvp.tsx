...
// открытка") — the whole form sits inside a bordered card with corner
// flourishes and a stamp-like seal mark, echoing the envelope/wax-seal motif
// from the Timer hero instead of floating as a plain section.
export function OldMoneyRsvp({ project, content, previewMode }: BlockProps<"rsvp">) {
  ...
  return (
    <Section bleed="contained" className="text-center">
      <div className="relative mx-auto max-w-lg border border-(--color-accent)/40 px-6 py-10 md:px-12 md:py-14">
